...
const SnippetDetail = () => {
    ...
    const snippet = useQuery(api.snippet.getSnippetById, { snippetId: snippetId as Id<"snippets"> });
    const comments = useQuery(api.snippet.getComments, { snippetId: snippetId as Id<"snippets"> });
